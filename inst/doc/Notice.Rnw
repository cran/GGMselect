...
\begin{aug}
\author{\fnms{Annie} \snm{Bouvier}\ead[label=e1]{Annie.Bouvier@jouy.inra.fr}},
\author{\fnms{Christophe} \snm{Giraud}\ead[label=e2]{Christophe.Giraud@polytechnique.edu}},
\author{\fnms{Sylvie} \snm{Huet}\ead[label=e3]{Sylvie.Huet@jouy.inra.fr}},
\and	
\author{\fnms{Nicolas} \snm{Verzelen}\ead[label=e4]{nicolas.verzelen@math.u-psud.fr}}
\address{INRA, MIA, 78352 Jouy-en-Josas Cedex, FRANCE\\ \printead{e1}}
\address{Ecole Polytechnique, CMAP, UMR 7641\\ Route de Saclay 
91128 Palaiseau Cedex, FRANCE  \\ \printead{e2}}
\address{INRA, MIA, 78352 Jouy-en-Josas Cedex, FRANCE\\ \printead{e3}}
...
\centerline{{Contact:} {\tt Annie.Bouvier@jouy.inra.fr}}
\medskip
...
\medskip
\noindent{\bf Download}: \url{http://w3.jouy.inra.fr/unites/miaj/public/logiciels/GGMselect/}
...
<<explotFast, keep.source=TRUE, fig=TRUE>>=
gV <- network(Gr$G)
...
<<explotMyFam, echo=FALSE,fig=TRUE>>=
# CACHER
# plot the result
g <- network(GMF$G)
